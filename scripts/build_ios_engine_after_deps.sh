#!/usr/bin/env bash
# Build orca_ios_api for iOS Simulator once deps finish, bundle, regen Xcode with ORCA_LINKED.
set -euo pipefail
...
echo "iOS engine ready. Rebuild Xcode for Simulator with ORCA_LINKED."
